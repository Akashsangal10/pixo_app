ActiveAdmin.register WorkBenefit do


  permit_params :title, :description, :title1, :description1, :title2, :description2, :title3, :description3, :title4, :description4, :title5, :description5, :title6, :description6
